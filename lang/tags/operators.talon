...
is {user.code_operators_assignment}: user.code_operator(code_operators_assignment)
is {user.code_operators_bitwise}: user.code_operator(code_operators_bitwise)
...
is {user.code_operators_math}: user.code_operator(code_operators_math)
